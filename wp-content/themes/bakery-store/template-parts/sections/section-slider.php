...
<div class="<?php if(esc_attr(get_theme_mod('slider_section_width','Full Width')) == 'Full Width'){ ?>container-fluid pd-0 <?php } elseif(esc_attr(get_theme_mod('slider_section_width','Full Width')) == 'Box Width'){ ?> container <?php }?>">
    ...
    <div class="swiper-container">
      <div class="swiper-wrapper">
        ...
        <?php 
          ...
          $slider_btn1text = esc_attr(get_theme_mod('slider_btn1text','Order Now'));
          $slider_btn2text = esc_attr(get_theme_mod('slider_btn2text','Contact Us'));
          $slider_btn2link = esc_attr(get_theme_mod('slider_btn2link','#'));
              ...
              <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12 pd-0">  <div class="slidersvg2">              
                  <div class="container slidercontent">
                    ...
                    <div data-swiper-parallax="500" class="slide-btns">
                      <a class="ReadMore" style="color: <?php echo apply_filters('bakerystore_slider', $slider_btntxt_color); ?>" href="<?php echo esc_url( get_permalink() ); ?>"><?php echo apply_filters('bakerystore_slider', $slider_btn1text); ?></a>

                      <a class="contactus" href="<?php echo apply_filters('bakerystore_slider', $slider_btn2link); ?>"><?php echo apply_filters('bakerystore_slider', $slider_btn2text); ?></a>
