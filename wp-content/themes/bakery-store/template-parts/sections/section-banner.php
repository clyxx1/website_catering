<div class="<?php if(esc_attr(get_theme_mod('banner_section_width','Full Width')) == 'Full Width'){ ?>container-fluid pd-0 <?php } elseif(esc_attr(get_theme_mod('banner_section_width','Full Width')) == 'Box Width'){ ?> container pd-0 <?php }?>">
