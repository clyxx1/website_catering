...
function bakerystore_header_style() {
	...
	$header_submenubordercolor = esc_attr(get_theme_mod('header_submenubordercolor','#fff'));
  	...
  	$productcat_disable_section = esc_attr(get_theme_mod('productcat_disable_section','YES'));
  	...
  	$popularproducts_disable_section = esc_attr(get_theme_mod('popularproducts_disable_section','YES'));
	...
	<?php
        if ($productcat_disable_section == 1):
	?>
		#catproduct-section {
			display: none;
		}
	...
	<?php
        if ($popularproducts_disable_section == 1):
	?>
