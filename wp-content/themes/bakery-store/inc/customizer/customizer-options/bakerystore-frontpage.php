...
$selective_refresh = isset( $wp_customize->selective_refresh ) ? 'postMessage' : 'refresh';
	   ...
	   'buttons' => array(
	      ...
	      array(
            ...
            'fields' => array(
                ...
                'slider_btntxt2color',
                'slider_btnbg2color',
                'slider_slidebarcolor',
                'slider_slidebaractivecolor'

            ),
     	),
		 array(
			 'name' => esc_html__('Layout', 'bakery-store'),
	...
	// slider btn1text 
	$sliderbtn1text = esc_html__('Order Now', 'bakery-store' );
	$wp_customize->add_setting(
    	'slider_btn1text',
    	array(
			'default' => $sliderbtn1text,
	...
	$wp_customize->add_control( 
		'slider_btn1text',
		array(
		    'label'   		=> __('Button 1 Text','bakery-store'),
		    'section'		=> 'slider_setting',
			'type' 			=> 'text',
	...
	// slider btn2text 
	$sliderbtn2text = esc_html__('Contact Us', 'bakery-store' );
	$wp_customize->add_setting(
    	'slider_btn2text',
    	array(
			'default' => $sliderbtn2text,
			'capability'     	=> 'edit_theme_options',
			'sanitize_callback' => 'wp_kses_post',
			'priority'      => 3,
		)
	...
	$wp_customize->add_control( 
		'slider_btn2text',
		array(
		    'label'   		=> __('Button 2 Text','bakery-store'),
		    'section'		=> 'slider_setting',
			'type' 			=> 'text',
			'transport'         => $selective_refresh,
		)  
	...
	// slider btn2link 
	$sliderbtn2link = esc_html__('#', 'bakery-store' );
	$wp_customize->add_setting(
    	'slider_btn2link',
    	array(
			'default' => $sliderbtn2link,
			'capability'     	=> 'edit_theme_options',
			'sanitize_callback' => 'wp_kses_post',
			'priority'      => 3,
		)
	...
	$wp_customize->add_control( 
		'slider_btn2link',
		array(
		    'label'   		=> __('Button 2 Link','bakery-store'),
		    'section'		=> 'slider_setting',
			'type' 			=> 'text',
			'transport'         => $selective_refresh,
		)  
	...
	// slider slidebar Color
	$sliderslidebarcolor = esc_html__('#fff', 'bakery-store' );
	$wp_customize->add_setting(
    	'slider_slidebarcolor',
    	array(
			'default' => $sliderslidebarcolor,
			'capability'     	=> 'edit_theme_options',
			'sanitize_callback' => 'wp_kses_post',
			'priority'      => 3,
		)
	...
	$wp_customize->add_control( 
		'slider_slidebarcolor',
		array(
		    'label'   		=> __('Slide Bar Color','bakery-store'),
		    'section'		=> 'slider_setting',
			'type' 			=> 'color',
			'transport'         => $selective_refresh,
		)  
	...
	// slider slidebaractive Color
	$sliderslidebaractivecolor = esc_html__('#bb8fe7', 'bakery-store' );
	$wp_customize->add_setting(
    	'slider_slidebaractivecolor',
    	array(
			'default' => $sliderslidebaractivecolor,
			'capability'     	=> 'edit_theme_options',
			'sanitize_callback' => 'wp_kses_post',
			'priority'      => 3,
		)
	...
	$wp_customize->add_control( 
		'slider_slidebaractivecolor',
		array(
		    'label'   		=> __('Slide Bar Active Color','bakery-store'),
		    'section'		=> 'slider_setting',
			'type' 			=> 'color',
			'transport'         => $selective_refresh,
		)  
	...
	$wp_customize->add_setting('slider_section_width',array(
        'default' => 'Full Width',
        'sanitize_callback' => 'bakerystore_sanitize_choices',
    ));
    $wp_customize->add_control('slider_section_width',array(
        'type' => 'select',
        'label' => __('Section Width','bakery-store'),
        'choices' => array (
            'Box Width' => __('Box Width','bakery-store'),
            'Full Width' => __('Full Width','bakery-store')
        ),
        'section' => 'slider_setting',
    ));
	...
	$wp_customize->add_control(
		new bakerystore_Toggle_Switch_Custom_Control(
			$wp_customize,
			'productcat_disable_section',
			array(
				'settings'      => 'productcat_disable_section',
				'section'       => 'productcat_setting',
				'label'         => __( 'Disable Section', 'bakery-store' ),
				'on_off_label'  => array(
					'on' => __( 'Yes', 'bakery-store' ),
					'off' => __( 'No', 'bakery-store' )
				),
			)
		)
	);
	...
	// Layout
	$wp_customize->add_setting('productcat_section_width',array(
        'default' => 'Box Width',
        'sanitize_callback' => 'bakerystore_sanitize_choices',
    ));
    $wp_customize->add_control('productcat_section_width',array(
        'type' => 'select',
        'label' => __('Section Width','bakery-store'),
        'choices' => array (
            'Box Width' => __('Box Width','bakery-store'),
	...
	$wp_customize->add_control(new bakerystore_Tab_Control($wp_customize, 'bakerystore_popularproducts_tabs', array(
	   ...
	   'buttons' => array(
	      array(
            ...
            'icon' => 'dashicons dashicons-welcome-write-blog',
            'fields' => array(
				'popularproducts_disable_section',
	...
	// hide show popularproducts section
	$wp_customize->add_setting(
		'popularproducts_disable_section',
		array(
			'sanitize_callback' => 'wp_kses_post',
	...
	$wp_customize->add_control(
		new bakerystore_Toggle_Switch_Custom_Control(
			...
			'popularproducts_disable_section',
			array(
				'settings'      => 'popularproducts_disable_section',
				'section'       => 'popularproducts_setting',
				'label'         => __( 'Disable Section', 'bakery-store' ),
				'on_off_label'  => array(
					'on' => __( 'Yes', 'bakery-store' ),
	...
	// Layout
	$wp_customize->add_setting('popularproducts_section_width',array(
        'default' => 'Box Width',
        'sanitize_callback' => 'bakerystore_sanitize_choices',
    ));
    $wp_customize->add_control('popularproducts_section_width',array(
        'type' => 'select',
        'label' => __('Section Width','bakery-store'),
        'choices' => array (
            'Box Width' => __('Box Width','bakery-store'),
