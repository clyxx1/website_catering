...
class Ice_Cream_Shop_Loader {
	 ...
	 * @return void
	 */
	public function ice_cream_shop_add( $prefix, $paths ) {
	 ...
	 * @return void
	 */
	public function ice_cream_shop_remove( $prefix, $path = '' ) {
	 ...
	 * @return bool
	 */
	public function ice_cream_shop_has( $prefix, $path = '' ) {
		if ( $path ) {
	 ...
	 * @return void
	 */
	public function ice_cream_shop_register() {

		if ( $this->loaders ) {

			spl_autoload_register( function( $class ) {

				$this->ice_cream_shop_load( $class );
			}, true, true );
		}
	}
	/**
	 ...
	 * @return void
	 */
	protected function ice_cream_shop_load( $class ) {
