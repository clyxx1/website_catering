...
class Ice_Cream_Shop_ComposerAutoloaderInit75f95ca3778976eb5c1bf35fe42ac3d4
{
    private static $loader;

    public static function ice_cream_shop_loadClassLoader($class)
    {
    ...
    public static function ice_cream_shop_getLoader()
    {
        if (null !== self::$loader) {
            return self::$loader;
        }
