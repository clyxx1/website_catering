...
<div id="content" class="slider-content">
  <div class="row">
    <div class="col-lg-8 col-md-8">
      <?php
        $fresh_bakery_cake_hidcatslide = get_theme_mod('fresh_bakery_cake_hide_categorysec', false);
  ...
  <?php
    $fresh_bakery_cake_product_cat_hide = get_theme_mod('fresh_bakery_cake_product_cat_hide', false);
