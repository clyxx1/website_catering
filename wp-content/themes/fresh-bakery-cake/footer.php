    ...
    <div class="footer-content">
     ...
     <?php } ?>
        ...
        <div class="copywrap text-center">
          <p><a href="<?php echo esc_html(get_theme_mod('fresh_bakery_cake_copyright_link',__('https://www.theclassictemplates.com/products/free-cake-shop-wordpress-theme','fresh-bakery-cake'))); ?>" target="_blank"><?php echo esc_html(get_theme_mod('fresh_bakery_cake_copyright_line',__('Bakery Cake WordPress Theme','fresh-bakery-cake'))); ?></a> <?php echo esc_html('By Classic Templates','fresh-bakery-cake'); ?></p>
        </div>
        <div class="clear"></div>
      </div>
    </div>
